...
<div class="padding-md">
	...
	<div>
	   <ul class="breadcrumb">
		   ...
		   <li><a href="/smartGarden/manager.php?s=/Schedules/timeList">时间设置</a></li>
		   <li>时间编辑</li>
					...
					<div class="smart-widget-body">
						<form class="form-horizontal no-margin" method="post" id="form">
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" class="form-control input-sm" name="info[start_time]" value="<?php echo ($start_time); ?>" id="start_time" placeholder="选择时间">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">下班时间</label>
								<div class="col-md-5">
									<input type="text" class="form-control input-sm" name="info[end_time]" value="<?php echo ($end_time); ?>" id="end_time" placeholder="选择时间">
								</div>
							</div>
							<!--<div class="form-group">-->
								...
								<!--<div class="col-md-5">-->
									<!--<div class="radio inline-block">-->
										<!--<div class="custom-radio m-right-xs">-->
											<!--<input type="radio" id="display1" name="info[is_show]" value="1" <?php if($is_show == 1): ?>checked<?php endif; ?>>-->
											<!--<label for="display1"></label>-->
										<!--</div>-->
										<!--<div class="inline-block vertical-top">正常</div>-->
										<!--<div class="custom-radio m-right-xs">-->
											<!--<input type="radio" id="display2" name="info[is_show]" value="0" <?php if($is_show == 0): ?>checked<?php endif; ?>>-->
...
<script type="text/javascript">
	...
	function confirm() {
		DMS.ajaxPost("/smartGarden/manager.php?s=/Schedules/timeEdit",$('#form').serialize(),function(ret){
			if(ret.status==1){
